...
class CloseLoopTask(object):
    ...
    def _calcWfsWfErrFromImg(
        self, obsId, butlerRootPath, instName, snap=0, simSeed=1000, numPro=1
    ):
    ...
    def runWfsWep(self, obsId, butlerRootPath, instName, numPro=1):
    ...
    def runPistonWep(self, extraObsId, intraObsId, butlerRootPath, instName, numPro=1):
